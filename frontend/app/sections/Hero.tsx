...
export default function Hero({ socialNetworks }: HeroProps) {
	return (
		<div className="relative min-h-screen overflow-hidden bg-[var(--black)] font-[var(--font)] flex flex-col justify-center gap-4 px-6 sm:px-10 lg:px-24 selection:bg-[var(--white)]/40">
